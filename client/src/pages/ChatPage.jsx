			...
			<div className='flex-grow flex flex-col p-4 md:p-6 lg:p-8 overflow-hidden max-w-4xl mx-auto w-full'>
				<div className='flex items-center mb-4 bg-white rounded-lg shadow p-3'>
					<img
						...
						className='w-12 h-12 object-cover rounded-full mr-3 border-2 border[#825644]'
					/>
...
const MatchNotFound = () => (
	<div className='h-screen flex flex-col items-center justify-center bg-gray-100 bg-opacity-50 bg-dot-pattern'>
		<div className='bg-white p-8 rounded-lg shadow-md text-center'>
			<UserX size={64} className='mx-auto text-[#825644] mb-4' />
			...
			<Link
				to='/'
				className='mt-6 px-4 py-2 bg-[#825644] text-white rounded hover:bg[#825644] transition-colors 
				focus:outline-none focus:ring-2 focus:ring-[#825644] inline-block'
			>
				Go Back To Home
			</Link>
		</div>
...
const LoadingMessagesUI = () => (
	<div className='h-screen flex flex-col items-center justify-center bg-gray-100 bg-opacity-50'>
		<div className='bg-white p-8 rounded-lg shadow-md text-center'>
			<Loader size={48} className='mx-auto text-[#825644] animate-spin mb-4' />
			...
			<div className='mt-6 flex justify-center space-x-2'>
				<div className='w-3 h-3 bg-[#825644] rounded-full animate-bounce' style={{ animationDelay: "0s" }}></div>
				<div
					className='w-3 h-3 bg-[#825644] rounded-full animate-bounce'
